...
describe('CatsService', () => {
  ...
  describe('getCats', () => {
    it('should return all cats', async () => {
      ...
      expect(await catsService.getCats()).toEqual(result);
    });
  });
  ...
  describe('getCatByID', () => {
    it('should return cat by ID', async () => {
      ...
      expect(await catsService.getCatByID(catID)).toEqual(result);
    });
  });
  ...
  describe('getCatByName', () => {
    it('should return cat by Name', async () => {
      ...
      expect(catsService.getCatByName(catName)).toEqual(result);
    });
  });
  ...
  describe('getCatByName error undefined', () => {
    it('should return error by Name', async () => {
      ...
      jest.spyOn(catsService, 'getCatByName').mockImplementation(() => result);
      expect(await catsService.getCatByName(catName)).toEqual(result);
    });
  });
  ...
  describe('addCat', () => {
    it('should return state of cats', async () => {
      ...
      expect(await catsService.addCat(cat)).toEqual(result);
    });
  });
  ...
  describe('updateCat', () => {
    it('should return state of cats', async () => {
      ...
      expect(await catsService.updateCat(catUpdate)).toEqual(result);
    });
  });
  ...
  describe('deleteCat', () => {
    it('should return message', async () => {
      ...
      expect(await catsService.deleteCat(catID)).toBe(result);
    });
  });
